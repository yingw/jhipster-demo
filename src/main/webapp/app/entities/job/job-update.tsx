    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="humanResourcesApp.job.home.createOrEditLabel">
              <Translate contentKey="humanResourcesApp.job.home.createOrEditLabel">Create or edit a Job</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : jobEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="jobTitleLabel" for="jobTitle">
                    <Translate contentKey="humanResourcesApp.job.jobTitle">Job Title</Translate>
                  </Label>
                  <AvField id="job-jobTitle" type="text" name="jobTitle" />
                </AvGroup>
                <AvGroup>
                  <Label id="minSalaryLabel" for="minSalary">
                    <Translate contentKey="humanResourcesApp.job.minSalary">Min Salary</Translate>
                  </Label>
                  <AvField id="job-minSalary" type="string" className="form-control" name="minSalary" />
                </AvGroup>
                <AvGroup>
                  <Label id="maxSalaryLabel" for="maxSalary">
                    <Translate contentKey="humanResourcesApp.job.maxSalary">Max Salary</Translate>
                  </Label>
