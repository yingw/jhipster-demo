  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="humanResourcesApp.department.delete.question">
          <Translate contentKey="humanResourcesApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
