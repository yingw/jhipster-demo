    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="humanResourcesApp.location.home.createOrEditLabel">
              <Translate contentKey="humanResourcesApp.location.home.createOrEditLabel">Create or edit a Location</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
