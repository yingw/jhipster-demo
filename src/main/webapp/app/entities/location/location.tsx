    ...
    return (
      <div>
        <h2 id="location-heading">
          <Translate contentKey="humanResourcesApp.location.home.title">Locations</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="humanResourcesApp.location.home.createLabel">Create new Location</Translate>
          </Link>
        </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="humanResourcesApp.location.streetAddress">Street Address</Translate>
                </th>
                <th>
                  <Translate contentKey="humanResourcesApp.location.postalCode">Postal Code</Translate>
                </th>
                <th>
                  <Translate contentKey="humanResourcesApp.location.city">City</Translate>
                </th>
                <th>
                  <Translate contentKey="humanResourcesApp.location.stateProvince">State Province</Translate>
                </th>
                <th>
