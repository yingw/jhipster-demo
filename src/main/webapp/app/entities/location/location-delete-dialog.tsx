  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="humanResourcesApp.location.delete.question">
          <Translate contentKey="humanResourcesApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
