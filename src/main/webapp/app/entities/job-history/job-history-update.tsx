    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="humanResourcesApp.jobHistory.home.createOrEditLabel">
              <Translate contentKey="humanResourcesApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="startDateLabel" for="startDate">
                    <Translate contentKey="humanResourcesApp.jobHistory.startDate">Start Date</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label id="endDateLabel" for="endDate">
                    <Translate contentKey="humanResourcesApp.jobHistory.endDate">End Date</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label id="languageLabel">
                    <Translate contentKey="humanResourcesApp.jobHistory.language">Language</Translate>
                  </Label>
                  <AvInput
