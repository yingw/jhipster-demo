  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="humanResourcesApp.jobHistory.delete.question">
          <Translate contentKey="humanResourcesApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
