    ...
    return (
      <div>
        <h2 id="country-heading">
          <Translate contentKey="humanResourcesApp.country.home.title">Countries</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="humanResourcesApp.country.home.createLabel">Create new Country</Translate>
          </Link>
        </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="humanResourcesApp.country.countryName">Country Name</Translate>
                </th>
                <th>
