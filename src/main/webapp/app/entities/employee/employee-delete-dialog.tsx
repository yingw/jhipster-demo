  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="humanResourcesApp.employee.delete.question">
          <Translate contentKey="humanResourcesApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
